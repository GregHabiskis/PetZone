...
export default function Home() {
  return <>
    <section className="hero" data-od-id="home-hero"><div className="shell hero-grid"><div className="hero-copy"><p className="eyebrow">CARE FOR EVERY KIND OF COMPANION</p><h1 data-od-id="hero-heading">Happy pets start here.</h1><p className="hero-lead">Food, medicine and everyday essentials — with friendly help whenever you need it.</p><div className="hero-actions"><Link href="/shop" className="primary-button" data-od-id="shop-best-sellers">Shop best sellers <ArrowRight /></Link><Link href="#shop-by-pet" className="secondary-button">Shop by pet</Link></div><div className="trust-chips"><span><BadgeCheck /> Authentic products</span><span><PackageCheck /> Easy returns</span><span><HeartPulse /> Helpful support</span></div></div><div className="hero-visual"><Image className="hero-pets" src="/media/cat-and-dog.jpg" alt="A cat and dog relaxing together" fill priority sizes="(max-width: 767px) 100vw, 48vw" /><div className="product-packs" aria-label="Real pet food products"><Image src="/media/royal-canin-cat-food.jpg" alt="Royal Canin cat food packet" width={180} height={180} /><Image src="/media/smartheart-dog-food.jpg" alt="SmartHeart dog food packet" width={170} height={170} /></div></div></div></section>
    ...
    <section className="pharmacy shell" data-od-id="pharmacy-feature"><div><ShieldCheck /><p className="eyebrow">PET PHARMACY & WELLNESS</p><h2>Health essentials, explained clearly.</h2><p>Shop everyday care, understand prescription verification, or ask our clinic team before you choose.</p><div className="hero-actions"><Link href="/pet-pharmacy" className="light-button">Shop health & pharmacy</Link><Link href="/vet-care" className="text-link">Ask the clinic <ArrowRight /></Link></div><small>Product information supports shopping and does not replace veterinary advice.</small></div><div className="pharmacy-list"><span><b>1</b> Choose care or medicine</span><span><b>2</b> Upload a prescription if required</span><span><b>3</b> We verify before fulfillment</span></div></section>
