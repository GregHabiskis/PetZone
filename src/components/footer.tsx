...
export function Footer() {
  return <footer className="footer" data-od-id="site-footer"><div className="shell footer-grid">
    ...
    <div><h3>Shop</h3><Link href="/shop">All products</Link><Link href="/brands">Shop by brands</Link><Link href="/pet-pharmacy">Pet Pharmacy</Link><Link href="/offer-zone">Offer Zone</Link></div>
