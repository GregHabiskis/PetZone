...
export function CheckoutForm({ customer }: { customer: Customer }) {
  ...
  <p className="consent-text">By placing an order on our website, you are agreeing with our <Link href="/terms-and-conditions" target="_blank">Terms & Conditions</Link> and <Link href="/privacy-policy" target="_blank">Privacy Policy</Link>.</p>
